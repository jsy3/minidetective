...
const { createTLSClient } = require('./tls-client');
...
const tlsClient = process.env.CLIENT_CERT_PATH && process.env.CLIENT_KEY_PATH
...
app.listen(PORT, '0.0.0.0', () => {
  console.log(`토큰 교환 서버: http://localhost:${PORT} (네트워크: http://192.168.151.110:${PORT})`);
  if (!tlsClient) {
